...
public class TNfeProc {
	...
	public static TNfeProc xmlToObject(String xml) throws Exception {
		JAXBContext context = JAXBContext.newInstance(TNfeProc.class);
		return context.createUnmarshaller().unmarshal(new StreamSource(new StringReader(xml)), TNfeProc.class)
				.getValue();
	}
}
