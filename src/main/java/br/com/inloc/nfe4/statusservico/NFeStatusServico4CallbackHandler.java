...
/**
 * NFeStatusServico4CallbackHandler Callback class, Users can extend this class and implement their own receiveResult and receiveError methods.
 */
public abstract class NFeStatusServico4CallbackHandler {
	...
	/**
	 * auto generated Axis2 call back method for nfeStatusServicoNF method override this method for handling normal response from nfeStatusServicoNF
	 * operation
	 */
	public void receiveResultnfeStatusServicoNF(br.com.inloc.nfe4.statusservico.NFeStatusServico4Stub.NfeResultMsg result) {
	}

	/**
	 * auto generated Axis2 Error handler override this method for handling error response from nfeStatusServicoNF operation
	 */
