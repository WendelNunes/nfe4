...
@XmlType(name = "TRetConsStatServ", propOrder = {"tpAmb", "verAplic", "cStat", "xMotivo", "cuf", "dhRecbto", "tMed", "dhRetorno", "xObs"})
public class TRetConsStatServ {
	...
	public static TRetConsStatServ xmlToObject(String xml) throws Exception {
		JAXBContext context = JAXBContext.newInstance(TRetConsStatServ.class);
		return context.createUnmarshaller().unmarshal(new StreamSource(new StringReader(xml)), TRetConsStatServ.class).getValue();
	}
}