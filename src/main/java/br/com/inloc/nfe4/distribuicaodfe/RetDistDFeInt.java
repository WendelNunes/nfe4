...
// Gerado em: 2020.10.07 às 04:19:07 PM BRT 
//
...
public class RetDistDFeInt {
	...
	public static RetDistDFeInt xmlToObject(String xml) throws Exception {
		JAXBContext context = JAXBContext.newInstance(RetDistDFeInt.class);
		return context.createUnmarshaller().unmarshal(new StreamSource(new StringReader(xml)), RetDistDFeInt.class)
				.getValue();
	}
}