...
/**
 * NFeDistribuicaoDFeCallbackHandler Callback class, Users can extend this class
...
public abstract class NFeDistribuicaoDFeCallbackHandler {
	...
	public void receiveResultnfeDistDFeInteresse(
			br.com.inloc.nfe4.distribuicaodfe.NFeDistribuicaoDFeStub.NfeDistDFeInteresseResponse result) {
	}
