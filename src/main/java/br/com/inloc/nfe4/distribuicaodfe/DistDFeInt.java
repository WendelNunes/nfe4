...
// Gerado em: 2020.10.14 às 04:31:34 PM BRT 
//
...
public class DistDFeInt {
	 ...
	 * 
	 * @param value allowed object is {@link DistDFeInt.ConsChNFe }
	 * 
	 */
	...
	public String getXML() throws Exception {
		...
		JAXBElement<DistDFeInt> element = new ObjectFactory().createDistDFeInt(this);
	...
	public static DistDFeInt xmlToObject(String xml) throws Exception {
		JAXBContext context = JAXBContext.newInstance(DistDFeInt.class);
		return context.createUnmarshaller().unmarshal(new StreamSource(new StringReader(xml)), DistDFeInt.class)
				.getValue();
	}
}
