...
// Gerado em: 2020.10.14 às 02:40:03 PM BRT 
//
...
@XmlType(name = "", propOrder = { "chNFe", "cnpj", "cpf", "xNome", "ie", "dhEmi", "tpNF", "vnf", "digVal", "dhRecbto",
		"nProt", "cSitNFe" })
...
public class ResNFe {
	...
	public static ResNFe xmlToObject(String xml) throws Exception {
		JAXBContext context = JAXBContext.newInstance(ResNFe.class);
		return context.createUnmarshaller().unmarshal(new StreamSource(new StringReader(xml)), ResNFe.class).getValue();
	}
}
