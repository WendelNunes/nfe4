...
// Gerado em: 2020.10.14 às 03:29:24 PM BRT 
//
...
public class TProcEvento {
	 ...
	 * 
	 * @param value allowed object is {@link TEvento }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link TRetEvento }
	 * 
	 */
	...
	public static TProcEvento xmlToObject(String xml) throws Exception {
		JAXBContext context = JAXBContext.newInstance(TProcEvento.class);
		return context.createUnmarshaller().unmarshal(new StreamSource(new StringReader(xml)), TProcEvento.class)
				.getValue();
	}
}
