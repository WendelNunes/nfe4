...
@XmlType(name = "TRetConsSitNFe", namespace = "http://www.portalfiscal.inf.br/nfe", propOrder = {"tpAmb", "verAplic", "cStat", "xMotivo", "cuf", "dhRecbto", "chNFe",
		"protNFe", "retCancNFe", "procEventoNFe"})
public class TRetConsSitNFe {
	 ...
	 * present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the procEventoNFe property.
	 * 
	 * <p>
	...
	public static TRetConsSitNFe xmlToObject(String xml) throws Exception {
		JAXBContext context = JAXBContext.newInstance(TRetConsSitNFe.class);
		return context.createUnmarshaller().unmarshal(new StreamSource(new StringReader(xml)), TRetConsSitNFe.class).getValue();
	}
}
